...
<html lang="es">
  <head>
    ...
    <meta name="author" content="Matias Tobares">
    ...
    <section class="login-content">
      ...
      <div class="login-box">
        ...
        <form class="login-form" name="formLogin" id="formLogin" action="">
          ...
          <div class="form-group">
            <div class="utility">
              <p class="semibold-text mb-2"><a href="#" data-toggle="flip">¿Olvidaste tú contraseña?</a></p>
            </div>
          </div>
        ...
        <form id="formRecetPass" name="formRecetPass" class="forget-form" action="">
          <h3 class="login-head"><i class="fa fa-lg fa-fw fa-lock"></i>Recuperar tú Contraseña</h3>
          <div class="form-group">
          ...
          <div class="form-group mt-3">
            <p class="semibold-text mb-0"><a href="#" data-toggle="flip"><i class="fa fa-angle-left fa-fw"></i> Volver a Iniciar Sesión</a></p>
          </div>
        </form>
      </div>
    </section>
