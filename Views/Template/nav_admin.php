<!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?=  media();?>/images/uploads/user.png" alt="User Image">
        <div>
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="<?= base_url();?>/clientes"><i class="app-menu__icon fa-solid fa-people-carry-box"></i><span class="app-menu__label">Clientes</span></a></li>
        <?php } ?>
        ...
        <li><a class="app-menu__item" href="<?= base_url();?>/pedidos">
          <i class="app-menu__icon fa-solid fa-list-check"></i><span class="app-menu__label">Pedidos</span></a></li>
        <?php } ?>
        <li><a class="app-menu__item" href="<?= base_url();?>/logout"><i class="app-menu__icon fa-solid fa-right-from-bracket"></i><span class="app-menu__label">Logout</span></a></li>
      </ul>
    </aside>
