  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 class="modal-title h4" id="myExtraLargeModalLabel">Permisos Roles de usuario </h5>
          ...
          <div class="tile">
            ...
            <form action="" id="formPermisos" name="formPermisos">
              ...
              <div class="text-center">
                ...
                <button class="btn btn-danger" type="button" data-dismiss="modal"><i class="fa fa-sign-out fa-lg" aria-hidden="true"></i>SALIR</button>
              </div>
            </form>
          </div>
        </div>
