...
document.addEventListener('DOMContentLoaded', function(){
    ...
    if( document.querySelector("#formUsuario")){
        ...
        // verifica que se respeten los formatos del campo por mas que ya lo indique como erroneo
        ...
        if(strPassword != "" || strPasswordConfirm != "")
            {   
                ...
                if(strPassword.length < 5 ){
                    swal("Atención", "La contraseña debe tener un mínimo de cinco caracteres." , "info");
                    return false;
                }
            }
